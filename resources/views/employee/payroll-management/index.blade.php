...
<div class="main-content"> 
    <div class="container table-responsive p-0"> 
        <table  id="pager" class="table auto-index wp-list-table widefat striped posts">
            ...
            @if(auth()->user()->emp_id == $salaries->emp_id)
            <tr>
                <td></td>
                <td>
                    {{ $salaries->month }} {{ $salaries->year }}
                </td>
                <td>
                    {{ number_format($salaries->basic_salary) }}
                </td>
                <td>
                    <a href="{{ route('pdfview',$salaries->id,['download'=>'pdf']) }}" class="btn btn-sm btn-danger btn-sqrt">Download</a>
                </td>
            </tr>
            @endif
            @endforeach
